...
namespace DTO
{
  ...
  public static class PersonExtensions
  {
    ...
    public static PersonResponse ToPersonResponse(this Person person)
    {
      ...
      return new PersonResponse() { PersonID = person.PersonID, PersonName = person.PersonName, Email = person.Email, DateOfBirth = person.DateOfBirth, ReceiveNewsLetters = person.ReceiveNewsLetters, Address = person.Address, CountryID = person.CountryID, Country=person.Country?.CountryName, Gender = person.Gender, 
